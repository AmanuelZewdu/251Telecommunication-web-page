...
const Contacthero = () => {
  return (
    <section className="contact-wrapper">
      <div className="contact-container flex items-center p-10 py-20 justify-between">
      ...
      <div className="contact-right w-[100%] flex-col justify-end flex gap-4 ml-[15%]">
        <h3 className='text-[--white] font-[500]'>Contact Us Today</h3>
         <input className='w-[50%] p-2 border-none' type='text' placeholder='Name'  />
         <input className='w-[50%] p-2  border-none' type='text' placeholder='Email' />
         <input className='w-[50%] p-2 h-[6rem]  border-none' type='text' placeholder='Your MESSAGE' />
         <button className='bg-[--yellow] p-2 w-[50%] text-[--white]'>REQUEST A cALL BACK</button>
