...
const NewsHero = () => {
  ...
  return (
    <section className="news-wrapper bg-[--white] p-10">
      <div className="news-container border-solid border-[1px] flex justify-center overflow-x-hidden items-start p-0  h-[500px]">
        {/* Main content area */}
        <div className='relative flex flex-col justify-center items-center w-2/3 h-full'>
          {/* Main image */}
        ...
        <div className='flex  p-[-10px] w-1/3 h-full'>
