    ...
    <section className="bg-[--white]">
      ...
      <div className="carer-container p-20">
        <div className="carer-text ">
          <h2 className="text-[--black] text-[2.5rem] font-[1000]">
          ...
          return (
            <div className="apply-container flex-col" key={i}>
              <div className=" relative table-container flex-col items-center  align-middle p-2 mt-8 after:contents-'' after:h-[2px] after:w-[100%] after:bg-[--black] after:absolute ">
                ...
                <div className="flex align-middle items-center justify-between p-6">
                    <h3 className="text-[1.2rem] text-[--black1] w-[100%]">{data.name}</h3>
                    <h3 className="text-[1.2rem] text-[--black1] w-[100%]">{data.city}</h3>
                    <h3 className="text-[1.2rem] text-[--black1] w-[100%]">{data.time}</h3>
