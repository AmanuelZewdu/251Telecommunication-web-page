  ...
  return (
    <section className="about-wrapper">
        ...
        <div className="about-mission flex items-center justify-between p-10 m-10">
          ...
          <div className="vision flex items-center justify-between p-10 m-10">
       ...
       <div className="right-content mb-2 flex flex-col align-middle justify-center gap-6">
        ...
        <FaCheck className='text-[--yellow]' size={15} />
         <p className='text-[--white]'> We are what we say we are, we are mavericks. </p>
          ...
          <div className="founder flex items-center justify-between">
            <div className="founder-left w-[100%]">
              <img src="placeholder.jpg" alt="placeholder" />
            </div>

            <div className="founder-right w-[100%] flex flex-col gap-3">
              <h3 className='text-[1.5rem] text-[--white]'>Founder & Ceo</h3>
              <h2 className='text-[2.8rem] text-[--yellow]'>MR.ADDIS ALEMAYHou</h2>
