...
const Aboutheader = () => {
    ...
    <div>
          ...
          <NavLink to='/about/digital' className='border-[1px] text-[--white1] border-solid border-[--white1] px-6 text-center w-[100%]'>
            <p>Digital</p>
          </NavLink>
          ...
          <NavLink to='/about/communication' className='border-[1px] text-[--white1]  border-solid border-[--white1] px-6 text-center w-[100%]'> 
            <p>communiction</p>
          </NavLink>
        </div>
